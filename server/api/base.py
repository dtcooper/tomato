...
from .utils import TomatoAuthError, dumps
...
class ConnectionsBase(MessagesBase):
    ...
    async def broadcast(self, message_type, message=None):
        raw_message = dumps({"type": message_type, "data": message})  # No sense serializing a bunch of times
        count = 0
